...
export const BuildingStorefrontIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 21v-7.5A.75.75 0 0114.25 12h.01a.75.75 0 01.75.75v7.5m-4.5 0v-7.5A.75.75 0 009.75 12h-.01a.75.75 0 00-.75.75v7.5m-4.5 0V7.5A2.25 2.25 0 015.25 5.25h13.5A2.25 2.25 0 0121 7.5v13.5m-18 0h18" />
...
export const ChatBubbleLeftRightIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.72 3.72a.75.75 0 01-1.06 0l-3.72-3.72C9.347 17.653 8.5 16.69 8.5 15.554v-4.286c0-.97.616-1.813 1.5-2.097m6.5 0v4.286c0 .621-.504 1.125-1.125 1.125H11.125c-.621 0-1.125-.504-1.125-1.125V8.511m6.5 0c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.72 3.72a.75.75 0 01-1.06 0l-3.72-3.72C6.347 17.653 5.5 16.69 5.5 15.554v-4.286c0-.97.616-1.813 1.5-2.097m6.5 0c-3 0-5.5 2.463-5.5 5.5v.528c0 .3-.122.583-.343.793l-1.11 1.111a.75.75 0 01-1.06-1.06l1.11-1.111a2.25 2.25 0 00.636-1.586V12.75c0-3.037 2.463-5.5 5.5-5.5s5.5 2.463 5.5 5.5v.528c0 .3-.122.583-.343.793l-1.11 1.111a.75.75 0 01-1.06-1.06l1.11-1.111a2.25 2.25 0 00.636-1.586V12.75c0-3.037-2.463-5.5-5.5-5.5z" />
  </svg>
);