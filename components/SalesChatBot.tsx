...
const industryActions: Record<string, Action[]> = {
  'インテリアコーディネーター': [
    ...
    { label: '家具・照明の選定', prompt: '提案中のコンセプトに合う、具体的な家具や照明のリストを3つずつ、オンラインで購入できるリンク付きで提案してください。' },
    { label: 'SNS投稿文の作成', prompt: '施工事例をInstagramに投稿するための、魅力的でエンゲージメントを高めるような投稿文を作成してください。ハッシュタグも10個提案してください。' },
  ],
  'リフォーム営業': [
    ...
    { label: '競合比較トーク', prompt: '相見積もりで競合している他社との差別化ポイントを明確にし、自社の強みをアピールするためのトークスクリプトを作成してください。' },
    { label: 'OB顧客へのアプローチ', prompt: '以前工事をさせていただいたOB顧客に対して、定期点検や新しいリフォーム提案を促すためのDM（ダイレクトメッセージ）の文面を作成してください。' },
  ],
  '不動産仲介': [
    ...
    { label: '住宅ローン相談への回答', prompt: '顧客から住宅ローンに関する質問（例：「頭金はどのくらい必要？」「変動金利と固定金利どっちがいい？」）をされた際の、分かりやすい回答例を教えてください。' },
    { label: '売主への報告書作成', prompt: '売主に対して、物件の販売活動の進捗（問い合わせ数、内見数、市場の反応など）を報告するための、簡潔なレポートのテンプレートを作成してください。' },
  ],
  '外壁塗装': [
    ...
    { label: '色選びのコツ', prompt: '外壁の色選びで失敗しないためのポイントや、人気の配色パターンを3つ、具体的な色名（例：サッシの色との組み合わせ）を交えて教えてください。' },
    { label: '保証内容の説明', prompt: '工事後の保証内容について、顧客の不安を解消し、安心感を与えるような説明の仕方を教えてください。' },
  ],
};
